...
@Configuration // Oznaczlismy tą klase, jako klasa zarządzana przez Springa
public class JpaConfiguration {

    @Bean // Oznaczlismy tą funkcje, jako funkcja która zwroci nam obiekt, zarządzany przez Springa
